...
"Bundle 'git@github.com:squizlabs/PHP_CodeSniffer.git'
...
autocmd FileType js set shiftwidth=2 tabstop=2 expandtab softtabstop=2
...
let g:neocomplcache_enable_auto_select = 15
" Plugin key-mappings.
